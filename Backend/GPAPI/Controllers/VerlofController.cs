...
namespace GPAPI.Controllers
{
    ...
    public class VerlofController : ControllerBase
    {
        ...
        public ActionResult GetVerlof()
        {
            ...
            //var response = _context.Verlof.Join(_context.Medewerkers, verlof => verlof.MedewerkerID, medewerker => medewerker.MedewerkerID, (verlof, medewerker) => new { verlof, medewerker });
